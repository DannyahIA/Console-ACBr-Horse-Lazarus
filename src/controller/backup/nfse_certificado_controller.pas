...
begin
  Header := Req.Headers.Content.Values['x-authorization'];//PARA RECEBER POR HEADER

  ResponseDescription := TNFSeService.GetCertificadoInfo(Json.Values['cnpj'].AsString);
